...
import { FAKE_DATA } from 'app/data/data';
...
export class DashboardComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    new Chart('chart-line', {
      ...
      options: this.chart1.options as ChartOptions
    });
    new Chart('chart-bar', {
      type: 'bar',
      data: this.chart2.data,
      options: this.chart2.options as ChartOptions
    });
    new Chart('chart-doughnut', {
      type: 'doughnut',
      data: this.chart3.data,
      options: this.chart3.options as ChartOptions
    });
